...
class MORA():
    def __init__(self, model, norm='Linf', eps=.3, seed=None, verbose=True,
                 ...
                 device='cuda', log_path=None, scale=True, decay_step='cosine',
                 scale_value=0.9, n_iter=100, float_dis=0.2,
    ...
    def run_standard_evaluation(self, x_orig, y_orig, bs=256):
        if self.verbose:
            ...
            for attack in self.attacks_to_run:
                ...
                for batch_idx in range(n_batches):
                    ...
                    if attack[:7] == 'mora-ce':
                        ...
                        _, adv_curr, adv_acc_result_batch = self.mora.perturb(x, y, cheap=True)
                        # breakpoint()
                        ...
                        _, adv_curr = self.mora_targeted.perturb(x, y, cheap=True)
